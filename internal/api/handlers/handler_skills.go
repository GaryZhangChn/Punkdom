...
type skillCreateRequest struct {
	Scope       punkdomskills.Scope `json:"scope"`
...
func (h *Handlers) HandleSkillDocument(ctx context.Context, c *app.RequestContext) {
	scope := punkdomskills.Scope(strings.TrimSpace(c.Query("scope")))
...
func (h *Handlers) HandleSkillCreate(ctx context.Context, c *app.RequestContext) {
	...
	body.Scope = punkdomskills.Scope(strings.TrimSpace(string(body.Scope)))

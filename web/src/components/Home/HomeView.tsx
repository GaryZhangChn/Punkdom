...
/** 书籍管理视图：集中展示、创建、打开和编辑 Punkdom 数据目录中的书籍。 */
export function HomeView({ workspace, punkdomDir, books, onSwitch, onBooksChange, onOpenCharacterCardImport, onClose }: HomeViewProps) {
                    ...
                    {orderedBooks.map((book) => {
                      ...
                      return (
                        ...
                        >
                          {(dragHandleProps) => (
                            <div
                              className={`group relative min-h-[188px] overflow-hidden rounded-[var(--punkdom-radius)] border text-xs transition-colors ${
                                isCurrent
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="mt-auto truncate pt-4 text-[10px] text-[var(--punkdom-text-faint)]">{book.path}</div>
                              </button>

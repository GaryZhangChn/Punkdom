  ...
  return (
    <Popover open={open}>
      ...
      <PopoverContent
        align="start"
        side="top"
        className="mb-2 w-[360px] border-[var(--punkdom-border)] bg-[var(--punkdom-menu-bg)] p-0 text-[var(--punkdom-text)]"
            ...
            <CommandGroup heading={headingLabel}>
              {visibleFiles.map((file) => (
                ...
                >
                  ...
                  {file.description && <span className="text-[11px] text-[var(--punkdom-text-muted)]">{file.description}</span>}
                </CommandItem>
              ))}
            </CommandGroup>
          </CommandList>

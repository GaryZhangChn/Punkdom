...
export function FileOperationDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="border-[var(--punkdom-border)] bg-[var(--punkdom-surface)] text-[var(--punkdom-text)]">
        <DialogHeader>
        ...
        <div className="space-y-2">
          <label className="text-xs text-[var(--punkdom-text-muted)]" htmlFor="file-operation-input">
            {t(meta.labelKey)}
          </label>
          <Input
            ...
            className="border-[var(--punkdom-border)] bg-[var(--punkdom-surface-2)] text-[var(--punkdom-text)]"
            autoFocus
          />

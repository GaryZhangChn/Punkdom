...
export function CommandPalette({
  ...
  return (
    <CommandDialog
      ...
      className="border-[var(--punkdom-border)] bg-[var(--punkdom-menu-bg)] text-[var(--punkdom-text)]"
    >
      <CommandInput
        placeholder={t('command.placeholder')}
        className="text-[var(--punkdom-text)] placeholder:text-[var(--punkdom-text-faint)]"
      />
        ...
        <CommandGroup heading={t('command.group.workbench')}>
          {actions.map((action) => (
            <CommandItem
              ...
              className="cursor-pointer text-[var(--punkdom-text)] data-[selected=true]:bg-[var(--punkdom-menu-item-hover-bg)]"
            >
              {action.icon}

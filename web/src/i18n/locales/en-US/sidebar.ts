const sidebar = {
  ...
  'sidebar.confirmDeleteOne': 'Delete {{path}}. Punkdom saves a version first, so you can restore it from version history.',
  'sidebar.confirmDeleteMany': 'Delete the selected {{count}} item(s). Punkdom saves a version first, so you can restore them from version history.',

const settings = {
  ...
  'settings.updates.installedRestart': 'Update installed. Restart Punkdom to use the new version.',
  ...
  'settings.updates.stagedRestart': 'Update staged. Close Punkdom to replace files automatically; the next launch will use the new version.',
  'settings.updates.updateAvailableTitle': 'New version available',
  'settings.updates.upToDateTitle': 'Punkdom is up to date',
  'settings.updates.userOnly': 'App updates are user-level settings. Switch to User Config to edit the auto-check policy.',
  'settings.backup.description': 'Export packages every project, setting, Trash item, knowledge file, and runtime record under the current Punkdom data directory. Restore overwrites the current data directory with the uploaded backup.',
  'settings.backup.error': 'Data backup failed',
  'settings.backup.export': 'Download Backup',
  'settings.backup.exportDone': 'Backup download has started.',
  'settings.backup.exporting': 'Packaging',
  'settings.backup.filenameHint': 'Backup filename format: Punkdom-timestamp.zip',
  'settings.backup.restore': 'Restore Backup',
  'settings.backup.restoreConfirm': 'Restore will overwrite all data under the current Punkdom data directory. Continue?',
  'settings.backup.restoreDone': 'Data restored. Refresh or switch views to see the latest state.',
  ...
  'settings.paths.punkdomDir': 'Punkdom Data Directory',

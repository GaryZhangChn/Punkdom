const settings = {
  ...
  'settings.updates.installedRestart': '更新已安装，重启 Punkdom 后生效。',
  ...
  'settings.updates.stagedRestart': '更新已暂存，关闭 Punkdom 后会自动替换文件，下次启动生效。',
  ...
  'settings.backup.description': '导出会打包当前 Punkdom 数据目录下的所有项目、配置、Trash、资料和运行数据；还原会用上传的备份覆盖当前数据目录。',
  'settings.backup.error': '数据备份失败',
  'settings.backup.export': '下载备份',
  'settings.backup.exportDone': '备份已开始下载。',
  'settings.backup.exporting': '打包中',
  'settings.backup.filenameHint': '备份文件命名格式：Punkdom-时间戳.zip',
  'settings.backup.restore': '还原备份',
  'settings.backup.restoreConfirm': '还原会覆盖当前 Punkdom 数据目录下的所有数据。确定继续吗？',
  'settings.backup.restoreDone': '数据已还原，请刷新或切换页面查看最新状态。',
  'settings.backup.restoring': '还原中',
  'settings.backup.title': '完整数据备份',
  ...
  'settings.paths.punkdomDir': 'Punkdom 数据目录',

  ...
  return (
    <div className="space-y-3">
      {triggers.map((trigger) => {
        ...
        return (
          <div key={trigger.id} className="rounded-[var(--punkdom-radius)] border border-[var(--punkdom-border)] bg-[var(--punkdom-surface)] p-3">
            ...
            <div className="mt-3 flex justify-end">
              <button type="button" onClick={() => removeTrigger(trigger.id)} className="punkdom-nav-item inline-flex items-center gap-1.5 rounded-[var(--punkdom-radius)] px-2 py-1 text-[var(--punkdom-text-muted)]">
      ...
      <div className="flex items-center gap-2">
        ...
        <button type="button" onClick={addTrigger} className="punkdom-nav-item inline-flex items-center gap-1.5 rounded-[var(--punkdom-radius)] border border-[var(--punkdom-border)] bg-[var(--punkdom-active)] px-3 py-1.5 text-[var(--punkdom-text)]">
